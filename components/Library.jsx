...
export default function Library({setView, setGlobalPlaylistId}) {
  ...
  return (
    <div className="flex-grow h-screen">
      <header className="text-white sticky top-0 h-20 z-10 text-2xl p-8 font-bold"></header>
      ...
      <div className="flex flex-col gap-4 px-8 h-screen overflow-y-scroll no-scrollbar">
          ...
          {playlists?.map((playlist) => {
            return (
              <div
                ...
                key={playlist.id}
                className="sursor-pointer relative group w-56 mb-2 bg-neutral-800 hover:bg-neutral-600 rounded-md p-4"
              >
